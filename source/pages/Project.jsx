        ...
        <div className="mt-10 flex flex-wrap gap-3 sm:gap-5 max-w-4xl">
          {LEARNED.map((w, i) => (
            <Reveal key={w} delay={i * 0.05}>
              <span
                className="inline-block font-serif italic text-2xl sm:text-4xl text-ink border-b-2 border-blush hover:border-wine hover:text-wine transition-colors duration-300 cursor-default"
