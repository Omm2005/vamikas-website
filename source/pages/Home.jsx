...
const CHAPTERS = [
  ...
  { n: "05", title: "the atelier", to: "/atelier", note: "what would you make?" },
];
...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 px-5 sm:px-16 w-full">
          ...
          >
            ...
            <MaskedLine delay={0.4} className="text-outline-blush italic">
              Menon
            </MaskedLine>
          </h1>
          <div className="mt-6 flex flex-col sm:flex-row sm:items-end gap-6 sm:gap-14">
            <MaskedLine delay={0.65} className="font-sans text-[11px] sm:text-xs tracking-[0.35em] uppercase text-smoke">
      ...
      <Marquee
        items={["messy", "fluid", "visual", "personal", "artistic"]}
        outline
        className="bg-paper"
      />

      <section data-testid="chapters-section" className="px-5 sm:px-16 py-24 sm:py-36">
        <Reveal>
        ...
        <Reveal delay={0.1} className="mt-14">
          <p className="font-sans text-sm leading-relaxed text-smoke max-w-xl">
            Fashion is expressing your emotions without words. Some people write, sing or
            dance to show what they feel —{" "}
