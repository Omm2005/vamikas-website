          ...
          <Reveal key={s.n} delay={i * 0.06} className={i % 3 === 1 ? "lg:mt-14" : i % 3 === 2 ? "lg:mt-28" : ""}>
            <div className={`group ${i % 2 ? "rotate-1" : "-rotate-1"} transition-transform duration-500 hover:rotate-0`}>
              <div className="flex items-baseline gap-4 mb-4">
                <span className="font-serif italic text-4xl text-blush group-hover:text-wine transition-colors duration-300">{s.n}</span>
        ...
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {TECHNIQUES.map((t, i) => (
            <Reveal key={t} delay={i * 0.04}>
              ...
              >
                <span className="font-hand text-2xl text-ink group-hover:text-blush transition-colors duration-300">
                  {t}
                </span>
              </div>
            </Reveal>
