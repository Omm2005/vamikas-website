  ...
  return (
    <div className="pt-5">
      <button
        ...
        className="font-hand text-2xl text-pink hover:text-burgundy-light transition-colors duration-300 -rotate-1"
      >
        ...
        {active && (
          ...
          >
            <button
              ...
              className="absolute top-6 right-6 text-cream hover:text-pink transition-colors"
              onClick={() => setActive(null)}
              aria-label="close"
            >
